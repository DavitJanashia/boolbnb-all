  ...
  var myClickChart = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        ...
        data: arrayNewClick,
        backgroundColor: ['rgba(255, 99, 132, 0.2)', 'rgba(54, 162, 235, 0.2)', 'rgba(255, 206, 86, 0.2)', 'rgba(75, 192, 192, 0.2)', 'rgba(153, 102, 255, 0.2)', 'rgba(60, 80, 130, 0.2)', 'rgba(255, 159, 64, 0.2)'],
        borderColor: ['rgba(255, 99, 132, 1)', 'rgba(54, 162, 235, 1)', 'rgba(255, 206, 86, 1)', 'rgba(75, 192, 192, 1)', 'rgba(153, 102, 255, 1)', 'rgba(60, 80, 130, 1)', 'rgba(255, 159, 64, 1)'],
        borderWidth: 1
      }]
    },
    options: {
  ...
  $.ajax({
    ...
    success: function success(data, state) {
      ...
      for (var _key in data) {
        var dataFormat = moment(data[_key]['current_date']).format("YYYY-MM-DD");
        arrayCurrentDatas.push(dataFormat);
        arrayNumOfClick.push(data[_key]['number_of_click']);
      }
...
module.exports = __webpack_require__(/*! /Users/giulia/Desktop/valet/code/boolbnb/resources/js/mychart.js */"./resources/js/mychart.js");
